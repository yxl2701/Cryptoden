...
ATTACK_NAME = "ECDSA已知Nonce比例"
ATTACK_DESC = "已知 k2 = alpha*k1 时恢复私钥"
ATTACK_HINT = "输入两组签名及 alpha，其中 k2 = alpha*k1，可恢复 k1、k2 和私钥 d。"
...
INPUT_FIELDS = [
    ...
    {'name': 'alpha', 'label': '比例 alpha', 'type': 'text', 'default': '', 'placeholder': 'k2/k1', 'required': True},
    {'name': 'r', 'label': '公共签名 r', 'type': 'text', 'default': '', 'placeholder': '0x...', 'required': True},
]


def attack(n, s1, z1, s2, z2, alpha, r):
    return affine_attack(n=n, s1=s1, z1=z1, s2=s2, z2=z2, alpha=alpha, beta='0', r=r)
